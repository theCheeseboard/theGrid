...
impl StatusColors {
    ...
    pub fn error(&self, cx: &App) -> Hsla {
        self.error
            .unwrap_or(cx.global::<Theme>().error_accent_color.into())
    }

    #[inline]
    pub fn error_background(&self, cx: &App) -> Hsla {
        let bg = Hsla::from(cx.global::<Theme>().error_accent_color);
    ...
    pub fn warning(&self, cx: &App) -> Hsla {
        self.warning
            .unwrap_or(cx.global::<Theme>().warning_accent_color.into())
    }

    #[inline]
    pub fn warning_background(&self, cx: &App) -> Hsla {
        let bg = Hsla::from(cx.global::<Theme>().warning_accent_color);
    ...
    pub fn info(&self, cx: &App) -> Hsla {
        self.info
            .unwrap_or(cx.global::<Theme>().info_accent_color.into())
    }

    #[inline]
    pub fn info_background(&self, cx: &App) -> Hsla {
        let bg = Hsla::from(cx.global::<Theme>().info_accent_color);
    ...
    pub fn success(&self, cx: &App) -> Hsla {
        cx.global::<Theme>().info_accent_color.into()
    }
