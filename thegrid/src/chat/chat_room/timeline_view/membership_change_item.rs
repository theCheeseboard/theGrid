...
impl RenderOnce for MembershipChangeItem {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        match self.membership_change.change() {
            ...
            .into_any_element(),
            Some(MembershipChange::Left) => state_change_element(
                Some("user".into()),
                tr!(
            ...
            Some(MembershipChange::Unbanned) => state_change_element(
                Some("user".into()),
                tr!(
            ...
            Some(MembershipChange::Invited) => state_change_element(
                Some("user".into()),
                tr!(
            ...
            .into_any_element(),
            Some(MembershipChange::Knocked) => state_change_element(
                Some("user".into()),
                tr!(
